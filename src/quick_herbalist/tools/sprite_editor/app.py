...
class SpriteEditorApp(App):
    def build(self):
        ...
        self.yaml_path = os.path.join("src", "quick_herbalist", "assets", "sprites.yaml")
        self.atlas_path = os.path.join("src", "quick_herbalist", "assets", "sprites.atlas")
