...
class FrameItem(BoxLayout, RecycleDataViewBehavior):
    ...
    def __init__(self, **kwargs):
        super().__init__(
            orientation="horizontal", size_hint_y=None, height="40dp", **kwargs
        )
        ...
        self.duration_input = TextInput(
            multiline=False, input_filter="int", size_hint_x=0.2
        )
...
class SequenceEditorWidget(BoxLayout):
    ...
    def _setup_ui(self):
        self.add_widget(
            Label(text="Frame Sequence Editor", size_hint_y=None, height="40dp")
        )
