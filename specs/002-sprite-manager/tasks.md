...
- [x] T003 [P] Create `src/quick_herbalist/tools/sprite_editor/ui/` directory structure with `__init__.py`
- [x] T004 [P] Register the `manage-sprites` CLI script entry point in `pyproject.toml`
